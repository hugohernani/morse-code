...
public class MorseCodeModel {
    ...
    static final long DOT = SPEED_BASE / 4;
    static final long DASH = SPEED_BASE * 4;
    static final long GAP = SPEED_BASE / 4;
    static final long LETTER_GAP = SPEED_BASE * 5;
    static final long WORD_GAP = SPEED_BASE * 10;
